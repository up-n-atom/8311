...
After rebooting the [WAS-110] or [X-ONU-SFPP], safely remove the LC/APC fiber optic cable from the {{ page.meta.ont }} and either connect it to an SC/APC adapter to the [WAS-110] or [X-ONU-SFPP], or replace the entire fibre with one suitable for the module.
