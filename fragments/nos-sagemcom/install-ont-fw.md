...
=== "X-ONU-SFPP"
    ...
    Although not strictly necessary for NOS, the 8311 community firmware is highly recommended for masquerading as
    the {{ page.meta.ont }} and used for the remainder of the [X-ONU-SFPP] sections of this guide.
