...
| **UART**    | Rx: pin 7 / Tx: pin 2              |                     |
| **IP**      | 192.168.11.1                       |                     |
| **HTTP(S)** | :check_mark:                       | [Web Credentials]   |
| **SSH**     | :check_mark: *Disabled by default* | [Shell Credentials] |
...
| [FEPL](https://ontolt.com/)           i        | [XGSPON-ONU-STICK ] | [Global Alibaba] :globe_with_meridians:                     | $160 USD  |               |
...
<small>^*^ Pricing and availability subject to change</small>
  ...
  [XGSPON-ONU-STICK ]: https://www.alibaba.com/product-detail/XGSPON-ONU-Stick-SFP-TX-9_11000017407584.html
