...
| **SSH**     | :check_mark: *Disabled by default (BFW/Azores firmware)* | [Shell Credentials] |
...
!!! tip "Participate in [group buys](/discord/#group-buys) on the 8311 Discord community server discounted pricing"
