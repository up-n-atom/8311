...
| ---------------------------------------------- | ----------------- | ------------------------------------------- | ------------ |
| [Ascent Optics](https://ascentoptics.com/)     | XSPU-P9T9R-NxCM   |                                             | PTXG         |
| [Azores Networks](https://azoresnetworks.com/) | XSS               |                                             | BFW/Azores   |
| [DZS](https://dzsi.com/)                       | 5311XP            |                                             |              |
| [E.C.I. Networks](https://ecin.ca/)            | EN-XGSFPP-OMAC-V2 | :check_mark:                                | BFW/Azores   |
| [FiberMall](https://www.fibermall.com/)        | XGSPON-ONU-STICK  | :check_mark:                                | BFW/Azores   |
